//! Custom format resource — a named set of specification conditions that
//! Whisparr evaluates to award a quality score to a release.
//!
...
pub struct CustomFormat {
    ...
    #[key]
    pub name: String,
    /// When true, the format name is included in Whisparr's file rename template.
