...
pub struct DelugeConfig {
    ...
    /// Label the client moves completed downloads to after Whisparr imports them.
    ...
    /// Directory Deluge saves in-progress downloads to.
    #[wire(name = "downloadDirectory")]
    pub download_directory: Option<String>,
    /// Directory Deluge moves downloads to once complete.
    #[wire(name = "completedDirectory")]
