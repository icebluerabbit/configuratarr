...
//!
//! `IndexerResource` in the eros spec is byte-identical to radarr's (18 fields):
//! confirmed via `get_resource crates/whisparr-v3/spec/whisparr-v3.json
//! "#/components/schemas/IndexerResource"`.
