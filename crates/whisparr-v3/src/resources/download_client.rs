...
//!
//! `DownloadClientResource` is confirmed identical (15 fields) to radarr's via
//! `get_resource crates/whisparr-v3/spec/whisparr-v3.json
//! "#/components/schemas/DownloadClientResource"`.
...
pub struct DownloadClient {
    ...
    #[default(1)]
    pub priority: i32,
    /// Remove downloads from the client once Whisparr has imported them.
    #[default(true)]
