...
//! Whisparr OpenAPI request schemas.
//!
...
//! The whisparr schemas are `additionalProperties: false`, so a hallucinated,
...
fn spec() -> Value {
    serde_json::from_str(include_str!("../spec/whisparr-v3.json")).expect("spec parses")
}
